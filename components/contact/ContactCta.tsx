...
export default function ContactCta({ onOpenForm }: ContactCtaProps) {
  useEffect(() => {
    const script1 = document.createElement('script');
    script1.src = 'https://fast.wistia.com/embed/medias/b2u1svt5hp.jsonp';
    script1.async = true;
  ...
  return (
    <section className="relative overflow-hidden bg-[#1B0A2E]" style={{ height: '100vh' }}>
      <div className="absolute inset-0" style={{ zIndex: 0 }}>
        <div
          className="wistia_embed wistia_async_b2u1svt5hp videoFoam=true autoPlay=true muted=true controlsVisibleOnLoad=false endVideoBehavior=loop playbar=false"
          style={{
            position: 'absolute',
            width: '100%',
            height: '100%',
