...
export default function SlabCta() {
  ...
  return (
    <section className="bg-[#1B0A2E] relative overflow-hidden flex items-center justify-center h-screen">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-8 md:px-16 text-center flex flex-col items-center justify-center">
        <h2
        ...
        >
          Get Premium Visuals. Skip the Wait.
        </h2>

        <p
          className="text-[#E2E8F0] mb-10"
          style={{
            fontFamily: "'Red Hat Display', sans-serif",
            fontSize: '24px',
            fontWeight: 500,
        ...
        >
          Book a 15-minute consultation, share your requirements, and receive your professional looping asset in weeks, not months.
        </p>
